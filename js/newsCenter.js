...
$(function(){
	var home={
		...
		bindEvent:function(){
			...
			//Tab切换
			$(".newsCConRCC ul li").find("a").hover(function(){
				var i=$(this).parent().index();
				$(this).addClass("newsCConRCActive").parent().siblings().find("a").removeClass("newsCConRCActive");
				
				$(".newsCConRB").find(".newsCWorkCom").eq(i).removeClass("newsCWorkComNone").siblings().addClass("newsCWorkComNone");
			})
		},
		render:function(){
			var that=this;
