...
$(function(){
	var home={
		...
		bindEvent:function(){
			...
			//Tab切换
			$(".raiderConRCC ul li").find("a").hover(function(){
				var i=$(this).parent().index();
				$(this).addClass("raiderConRCActive").parent().siblings().find("a").removeClass("raiderConRCActive");
				
				$(".raiderConRB").find(".raiderWorkCom").eq(i).removeClass("raiderWorkComNone").siblings().addClass("raiderWorkComNone");
			})
		},
		render:function(){
			var that=this;
